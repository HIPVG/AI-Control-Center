...
class EvidenceRegistry:
    ...
    def __init__(self) -> None:
        self._definitions = {
            ...
            "cross_model_baseline_artifact": EvidenceDefinition("cross_model_baseline_artifact", self._artifact),
            "cross_model_comparison_artifact": EvidenceDefinition("cross_model_comparison_artifact", self._artifact),
            "cross_model_condition": EvidenceDefinition("cross_model_condition", _mapping_with("condition_fingerprint", "baseline_model", "comparison_model")),
            "cross_model_validation": EvidenceDefinition("cross_model_validation", self._test_result),
            "cross_model_metrics": EvidenceDefinition("cross_model_metrics", _mapping_with("baseline", "comparison", "truncated_response_count")),
            "cross_model_quality_assessment": EvidenceDefinition("cross_model_quality_assessment", _mapping_with("conclusion", "limitations", "artifact_path")),
