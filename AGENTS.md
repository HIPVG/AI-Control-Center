...
- After successfully publishing any reviewer-facing report, end the current Codex turn at the safe checkpoint. Do not poll PR #1 from inside Codex; the watcher owns response acquisition and continuation.
